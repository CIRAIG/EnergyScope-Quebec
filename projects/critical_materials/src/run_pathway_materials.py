...
def run_pathway_materials(
    ...
    if(materials_recycling):
        ...
        mod_2_path.append(str(pth_materials / 'Material_recycling_fixture.dat'))  # collection_rate / recycling_cost / disposal_cost / gwp (no source data yet, dummy test values)
